...
class SynthesisState:
    ...
    def __init__(self, expr: Expr, replacements: Dict[Expr, Expr] = {}):
        ...
        # Cache compiled evaluators across score calls for the same state. The
        # shared scoring helper also uses this shape for Smir candidates.
        self._compiled_cache: CompiledCache = {}
    ...
    def get_score(self, oracle: SynthesisOracle, variables: List[Expr]) -> float:
        ...
        return score_expression(self._expr, oracle, variables, self._compiled_cache)
